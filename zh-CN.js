...
//Nekofuse Info
t1.push("1. There are two Fuse Options, Fusing <strong>10 Common's</strong> -&gt; <strong>1 Rare</strong> <u><i>OR</i></u> Fusing <strong>10 Rare</strong> -&gt; <strong>1 Epic</strong><br>2. The Fusion <strong>Success Rate</strong> will be determined by the following formula: <strong>SUCCESS_CHANCE = TOTAL_NYA_SCORE / 10</strong><br>3. If you <strong>Succeed</strong>, all <strong>10</strong> of your provided Season Catgirls will be burned, and you will obtain a new higher rarity Season Catgirl<br>4. If you <strong>Fail</strong>, the system will randomly pick <strong>5</strong> of your provided Season Catgirls to burn<br>5. Each newly generated Catgirl will belong to a Season that is determined by the previously provided Catgirls and their pertaining Seasons<br><br>For more details please check out the <strong>whitepaper</strong>: https://wiki.catgirl.io/<br><br><strong>DISCLAIMER: </strong> Even though this software has been thoroughly tested, this software's content and functionalities are still experimental. By using this software, you agree to hold catgirl.io harmless and not liable for any losses of the cryptocurrency assets or NFTs. Please use this software at your own risk");
t2.push("1. 有两种合成选项，<strong>10只普通</strong> -&gt; <strong>1只稀有</strong> <u><i>或者</i></u> <strong>10只稀有</strong> -&gt; <strong>1只史诗</strong><br>2. 合成<strong>成功率</strong>由此公式决定：<strong>成功率 = 所有材料总 Nya 分 / 10</strong><br>3. 如果合成<strong>成功</strong>，作为材料的<strong>10只</strong>猫娘将销毁，您将获得一只全新的猫娘<br>4. 如果合成<strong>失败</strong>，系统将随机抽取<strong>5只</strong>作为材料的猫娘销毁<br>5. 合成生成哪一季度的猫娘将以材料猫娘的季度确定<br><br>更多信息请查阅<strong>白皮书</strong>： https://wiki.catgirl.io/<br><br><strong>免责声明：</strong> 即使该应用已经过大量测试，但仍处于试验阶段。 使用本应用即表示您同意 catgirl.io 不对加密货币资产或 NFT 的任何损失承担责任。 请自行承担使用此应用的风险");
